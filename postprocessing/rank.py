...
input_path = 'data/over-under/v1-dataset-gp.csv'
output_path = 'data/over-under/v1-dataset-gp-ranked.csv'  # You can change this as needed
...
# Optionally, drop the original numerical columns except 'season', 'total', 'ou_line'
# Uncomment the following lines if you want to remove the original numerical columns
# df = df.drop(columns=numerical_cols)

# Save the modified DataFrame to a new CSV file
df.to_csv(output_path, index=False)

print(f"Successfully converted numerical features to ranks and saved to {output_path}")
